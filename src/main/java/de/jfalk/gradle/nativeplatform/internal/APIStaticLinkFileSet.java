...
class APIStaticLinkFileSet implements MinimalFileSet, Buildable {

  private final Logger logger;

  protected final JFStaticLibraryBinarySpecInternal owner;
  protected final DomainObjectSet<ComponentSpec>    inputInterfaceSets;

  public APIStaticLinkFileSet(
      final JFStaticLibraryBinarySpecInternal owner,
