...
//    println "platforms:       " + platforms.withType(NativePlatform.class);
//    println "nativePlatforms: " + nativePlatforms.defaultPlatformDefinitions();
...
//    println "allPlatforms: " + allPlatforms;
      ...
      for (NativePlatform platform : allPlatforms) {
        for (BuildType buildType : project.getExtensions().getByType(BuildTypeContainer.class)) {
          for (Flavor flavor : project.getExtensions().getByType(FlavorContainer.class)) {
            ...
            binaries.add(new JFalkStaticLibraryBinary(name, flavor, platform, buildType));
            binaries.add(new JFalkSharedLibraryBinary(name, flavor, platform, buildType));
          }
        }
      }
    }
